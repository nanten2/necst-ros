...
def oneshot(req):
    ...
    data = [
        [[10000.0+np.random.randint(100) for i in range(16384)] for i in range(int(req.repeat))],
        [[20000.0+np.random.randint(100) for i in range(16384)] for i in range(int(req.repeat))]
]
    data0 = []
    data1 = []
