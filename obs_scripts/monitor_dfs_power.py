...
p.add_argument("--dt", type=float, help="absolute path for dt")
p.add_argument("--n", type=int, help="absolute path for n")
p.add_argument("--ts", type=float, help="absolute path for ts")
p.add_argument("--m1", type=float, help="absolute path for m1")
p.add_argument("--m2", type=float, help="absolute path for m2")
p.add_argument(
    "--memo", type=str, help="Working memo. This will be include in directroy name."
)
p.add_argument(
    "--graph", type=str, help="Working memo. This will be include in directroy name."
)
