...
import get_xffts_data#shiotani added

dp = doppler_nanten.doppler_nanten()
gx = get_xffts_data.get_xffts_data()#shiotani added
...
sys.path.append("/home/amigos/ros/src/necst/lib")
import XFFTS_n2fits_write as n2fits_write
