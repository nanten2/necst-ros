    ...
    def act_azel(self):
        ...
        while True:
            ...
            if ret == None:
                ...
                ret0 = self.dev.move_azel(tar_az, tar_el, self.enc_parameter['az_enc'], self.enc_parameter['el_enc'])
                ret = self.dev.move_azel(tar_az_, tar_el_, self.enc_parameter['az_enc'], self.enc_parameter['el_enc'])
