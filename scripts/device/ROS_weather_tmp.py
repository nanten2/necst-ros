...
class weather_controller(object):
    ...
    def __init__(self):
        ...
        self.sub = rospy.Subscriber("cabin_ondotori", tr7nw_values, self.cabin_ondotori)        
    ...
    def pub_func(self):
        ...
        while not rospy.is_shutdown():
            ...
            msg.cabin_temp1 = self.cabin_temp1
            msg.cabin_temp2 = self.cabin_temp2
    ...
    def cabin_ondotori(self,req):
        self.cabin_temp1 = req.ch1_value + 273 #shiotani 273 C=>K
        self.cabin_temp2 = req.ch2_value + 273 #shiotani 273 C=>K
        return

    
    def get_ondotori(self,req):
        self.OutTemp = req.ch1_value+273.15
        self.OutHumi = req.ch2_value/100
        return
