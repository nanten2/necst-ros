...
class dome_controller(object):
    ...
    def move(self, dist):
        ...
        pos_arcsec = float(self.enc_az)#[arcsec]
        pos = pos_arcsec/3600.
        pos = pos % 360.0
        dist = dist % 360.0
        diff = dist - pos
...
if __name__ == '__main__':
    ...
    d = dome_controller()
    d.start_thread_ROS()
    sub1 = rospy.Subscriber('status_encoder', Status_encoder_msg, d.set_enc_param)
