...
savedir = '/home/amigos/data/hot_monitor/'
numpy.save(os.path.join(savedir, '%s_%s_dfs01.npy'%(name, timestamp)), data_d1)
numpy.save(os.path.join(savedir, '%s_%s_dfs02.npy'%(name, timestamp)), data_d2)
numpy.save(os.path.join(savedir, '%s_%s_timestamp.npy'%(name, timestamp)), data_time)
# numpy.savetxt(os.path.join(savedir, '%s_temp.txt'%(name)), [cabin_temp])
